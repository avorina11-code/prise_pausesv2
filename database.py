...
La base mvola_ae.db est stockée dans le même dossier que l'application.
Sur Streamlit Cloud ou un serveur GitHub, ce dossier persiste tant que
l'application tourne. Pour une sauvegarde externe, exportez via le bouton CSV.
"""
...
# --------------------------------------------------------------------------
# Chemin de la base — dossier de l'application (comportement d'origine)
# --------------------------------------------------------------------------
DB_PATH = str(Path(__file__).parent / "mvola_ae.db")
